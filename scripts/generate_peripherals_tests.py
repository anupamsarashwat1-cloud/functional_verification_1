...
peripherals_dir = "/home/anupam-sarashwat/project_penguin_verification/peripherals"
cocotb_dir = "/home/anupam-sarashwat/project_penguin_verification/verification/cocotb/peripherals"

os.makedirs(cocotb_dir, exist_ok=True)

v_files = [f for f in os.listdir(peripherals_dir) if f.endswith('.v')]
...
for vf in v_files:
    ...
    with open(os.path.join(peripherals_dir, vf), 'r') as f:
        content = f.read()
    ...
    if "pclk" in inputs:
        clk_name = "pclk"
    elif "sys_clk" in inputs:
        clk_name = "sys_clk"
    elif "core_clk" in inputs:
        clk_name = "core_clk"
    elif "pcie_clk" in inputs:
        clk_name = "pcie_clk"
    elif "pipe_clk" in inputs:
        clk_name = "pipe_clk"
    elif "eth_clk" in inputs:
        clk_name = "eth_clk"
    elif "gtx_clk" in inputs:
        clk_name = "gtx_clk"
    elif "can_clk" in inputs:
        clk_name = "can_clk"
...
COMPILE_ARGS += -I../../../../common -I../../../../peripherals
...
print(f"Peripherals test environments generated for {len(v_files)} modules.")
